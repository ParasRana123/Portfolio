  ...
  return (
    ...
    className={`flex w-full sm:flex-col-reverse items-center gap-8 ${
        ...
        <div>
            ...
            <a href={link} target="_blank" rel="noopener noreferrer" className={`text-lg flex gap-2 items-center text-cyan-500 hover:text-orange-500 transition-all duration-500 cursor-pointer sm:justify-self-center ${align == 'left' ? 'md:justify-self-end' : 'md:justify-self-start'}`}>View <BiSolidRightTopArrowCircle /></a>
        </div>
