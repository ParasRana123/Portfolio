...
const AboutMeText = () => {
  return (
    <div className='flex flex-col self-center md:self-start md:text-left sm:text-center'>
        ...
        <a href='/resume.pdf' download target="_blank" rel="noopener noreferrer" className='border border-orange-500 rounded-full py-2 px-4 text-lg flex items-center mt-10 hover:bg-orange-500 transition-all duration-500 cursor-pointer md:self-start sm:self-center text-white w-fit justify-center hover:text-cyan-400'>View Resume</a>
    </div>
  )
}
