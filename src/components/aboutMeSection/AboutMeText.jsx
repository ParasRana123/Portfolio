...
const AboutMeText = () => {
  return (
    <div className='flex flex-col md:items-start sm:items-center md:text-left sm:text-center'>
        ...
        <a href='/resume.pdf' target="_blank" rel="noopener noreferrer" className='border border-orange-500 rounded-full py-2 px-4 text-lg flex items-center mt-10 hover:bg-orange-500 transition-all duration-500 cursor-pointer md:self-start sm:self-center text-white hover:text-cyan-400'>My Resume</a>
    </div>
  )
}
